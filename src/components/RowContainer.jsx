    ...
    >
      {data &&
        data.map((item) => (
          <div
            key={item?.id}
            className="w-300 min-w-[300px] h-[215px] md:min-w-[340px] md:w-340 bg-gray-100 rounded-lg p-2 pr-6 backdrop-blur-lg my-12 hover:drop-shadow-lg flex flex-col items-center justify-between"
          >
